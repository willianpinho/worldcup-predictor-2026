...
import type { KnockoutModel, KnockoutRun } from "@/lib/knockout/schema";

const MODEL_COLOR: Record<KnockoutModel, string> = {
  claude: "text-claude",
  gemini: "text-gemini",
  openai: "text-openai",
};
...
/** Third-place result text, e.g. "T03 1–1 (4–2 p) T04". */
function thirdPlaceLine(tp: KnockoutRun["rounds"]["thirdPlace"]): string {
  if (
...
export function ChampionBanner({ run }: { run: KnockoutRun }) {
